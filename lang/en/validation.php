...
return [
    ...
    */
    ...
    'accepted_if' => 'The :attribute должен быть конда :other имеет значение :value.',
    'active_url'           => 'Поле :attribute не верное значение URL.',
    ...
    'max'                  => [
        'numeric' => 'Поле :attribute должно быть не больше :max символов.',
    ...
    'min'                  => [
        'numeric' => 'Поле :attribute должно быть не менее :min символов.',
    ...
    'prohibited_unless' => 'Поле :attribute запрещено пока :other находиться в :values.',
    ...
    'same'                 => 'Значение :attribute должно совпадать с :other must match.',
    'size'                 => [
