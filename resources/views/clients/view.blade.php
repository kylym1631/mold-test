                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                    ...
                                    <li class="breadcrumb-item text-dark">Клиент</li>
                                    <!--end::Item-->
                                </ul>
                                <!--end::Title-->
                            </div>
                    ...
                    <div class="post d-flex flex-column-fluid" id="kt_post">
                        ...
                        <div id="kt_content_container" class="container-fluid">
                                    ...
                                    <div class="row mb-5">
                                        <div class="col">
                                            <div class="row mb-5">
                                                ...
                                                <div class="col">
                                                    <div class="d-flex flex-column mb-0 fv-row">
                                                        <label for="address" class="fs-5 fw-bold mb-2">Адрес</label>
                                                        {{$client->address}}
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mb-5">
                                                <div class="col">
                                                    ...
                                                    <ul>
                                                        @foreach ($h_v_industry as $item)
                                                        <li>{{$item[1]}}</li>
                                                        @endforeach
                                                    </ul>
                                                </div>
                                                <div class="col">
                                                    <label for="industry_id" class="form-label">Место работы</label>
                                                    <ul>
                                                        @foreach ($h_v_city as $item)
                                                        <li>{{$item[1]}}</li>
                                                        @endforeach
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="row mb-5">
                                                <div class="col">
                                                    ...
                                                    <ul>
                                                        @foreach ($h_v_nationality as $item)
                                                        <li>{{$item[1]}}</li>
                                                        @endforeach
                                                    </ul>
                                                </div>
                                                <div class="col">
                                                    <label for="nationality_id" class="form-label">Жилье</label>
                                                    <ul>
                                                        @foreach ($h_v_housing as $item)
                                                        <li>{{$item[1]}}</li>
                                                        @endforeach
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="mt-10">
                                                ...
                                                <div class="row mb-5">
                                                    <div class="col">
                                                        <label for="work_time_format" class="form-label d-block">Формат</label>
                                                        @if (!$client->work_time_format
                                                        ||$client->work_time_format == 'natural')
                                                        ЧЧ:ММ - часы    
                                                        @endif

                                                        @if ($client->work_time_format == 'decimal')
                                                        ЧЧ,ММ - десятичные    
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="col">
                                                        <div class="d-flex flex-column mb-0 fv-row">
                                                            <label class="form-label d-block">Мин. кол-во часов</label>
                                                            {{$client->min_work_time_dec}}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

                                            @include('clients.includes.view-position')
                                        </div>
                                                ...
                                                <div class="contact">
                                                    <div class="row mb-5">
                                                        <div class="col">
                                                            <div class="d-flex flex-column mb-0 fv-row">
                                                                <label for="salary"
                                                                    class="fs-5 fw-bold mb-2">Имя</label>
                                                                {{$contact->firstName}}
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="d-flex flex-column mb-0 fv-row">
                                                                <label for="salary"
                                                                    class="fs-5 fw-bold mb-2">Фамилия</label>
                                                                {{$contact->lastName}}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-5">
                                                        <div class="col">
                                                            <div class="d-flex flex-column mb-0 fv-row">
                                                                <label for="salary"
                                                                    class="fs-5 fw-bold mb-2">Должность</label>
                                                                {{$contact->position}}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-5">
                                                        <div class="col">
                                                            <div class="d-flex flex-column mb-0 fv-row">
                                                                <label for="salary"
                                                                    class="fs-5 fw-bold mb-2">Email</label>
                                                                {{$contact->email}}
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="d-flex flex-column mb-0 fv-row">
                                                                <label for="salary"
                                                                    class="fs-5 fw-bold mb-2">Телефон</label>
                                                                {{$contact->phone}}
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            @if (!Auth::user()->isRealEstateManager() && !Auth::user()->isAccountant())
                            <div class="card mt-10">
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-tabs nav-line-tabs fs-6">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_pane_2">Часы
                                                работы</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
                                        <div class="card shadow-none js-data-table-wrap">
                                                ...
                                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                                    ...
                                                    <div class="w-250px">
                                                        <div class="d-flex align-items-center position-relative my-1">
                                                            ...
                                                            <!--end::Svg Icon-->
                                                            <input id="js-filter-by-month" type="text" class="js-filter-by-month form-control form-control-solid ps-14 flatpickr-input" name="period" data-format="month">
                                                        </div>
                                                    </div>

                                                    <div class="w-150px">
                                                        <!--begin::Select2-->
                                                        <select id="js-filter-by-status" class="js-filter form-select form-select-solid"
                                                            data-placeholder="Статус" name="status" multiple>
                                            ...
                                            <!--begin::Card body-->
                                            <div class="card-body pt-0">
                                                @include('work-logs.include.table')

                                                <!--begin::Table-->
                                                {{-- <div class="table-responsive">
                                                    <table
                                                        class="js-data-table table align-middle table-row-dashed fs-6 gy-3"
                                                        data-route="{{route('work-logs.json')}}" data-tpl="WorkLogs"
                                                        id="WorkLogsTable">
                                                        <!--begin::Table head-->
                                                        <thead>
                                                            <!--begin::Table row-->
                                                            <tr class="text-start text-muted fw-bolder fs-7 gs-0">
                                                                ...
                                                                <th class="sorting_disabled">Имя</th>
                                                                <th class="sorting_disabled">Фамилия</th>
                                                                <th class="sorting_disabled">Должность</th>
                                                                <th class="sorting_disabled">Работодатель</th>
                                                                
                                                                @for ($i = 0; $i < 31; $i++)
                                                                <th class="sorting_disabled">{{$i+1}}</th>    
                                                                @endfor

                                                                <th class="sorting_disabled">Часы</th>
                                                                <th class="sorting_disabled">Ставка</th>
                                                                <th class="sorting_disabled">Зарплата</th>
                                                                <th class="sorting_disabled">Жилье</th>
                                                                <th class="sorting_disabled">Штрафы</th>
                                                                <th class="sorting_disabled">БХП - форма</th>
                                                                <th class="sorting_disabled">Карты по быта (стоимоcть)</th>
                                                                <th class="sorting_disabled">Премия</th>
                                                                <th class="sorting_disabled">Рекоменации</th>
                                                                <th class="sorting_disabled">Транспорт</th>
                                                                <th class="sorting_disabled">Разрешения на работу</th>
                                                                <th class="sorting_disabled">Координатор</th>
                                                            </tr>
                                                            <!--end::Table row-->
                                                        </thead>
                                                        <tbody class="text-gray-600 fw-bold"></tbody>
