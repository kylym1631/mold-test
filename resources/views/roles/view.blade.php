                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                    ...
                                    <li class="breadcrumb-item text-dark">Роли и разрешения</li>
                                    <!--end::Item-->
                                </ul>
                                <!--end::Title-->
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="card-header mb-15" style="padding: 0">
                                        ...
                                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                            <a href="/roles/add?id={{$item->id}}" class="btn btn-primary btn-sm">Редактировать</a>
                                        </div>    
                                        @endif
                                    </div>
                                    ...
                                    <div class="mt-15 pb-2">
                                        <h4 class="fw-bolder m-0">Разрешения</h4>
                                    </div>
