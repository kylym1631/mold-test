                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                    ...
                                    <li class="breadcrumb-item text-dark">Добавить роль</li>
                                    <!--end::Item-->
                                </ul>
                                <!--end::Title-->
                            </div>
                        ...
                        <div id="kt_content_container" class="container-fluid">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-15">
                                    ...
                                    <div id="vue-app">
                                        <roles-permissions 
                                            role-item="{{isset($item) ? json_encode($item) : null}}"
                                        ></roles-permissions>
                                    </div>


                                    {{-- <form id="item-form" action="{{route('roles.create')}}" method="POST"
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-6">
                                                <div class="d-flex flex-column mb-5 fv-row">
                                                    ...
                                                    <input @if(isset($item)) value="{{$item->name}}" @endif
