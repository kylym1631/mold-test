                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                    ...
                                    <li class="breadcrumb-item text-dark">Роли</li>
                                    <!--end::Item-->
                                </ul>
                                <!--end::Title-->
                            </div>
                            ...
                            <div class="card js-data-table-wrap">
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    ...
                                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                        <a href="/roles/add" class="btn btn-primary">Добавить</a>
                                    </div>
                                    <!--end::Card toolbar-->
                                </div>
                                <!--begin::Card body-->
                                <div class="card-body pt-0">
                                    ...
                                    <div class="table-responsive">
                                        <table class="js-data-table table align-middle table-row-dashed fs-6 gy-3" data-route="{{route('roles.json')}}" data-tpl="Roles">
                                            <!--begin::Table head-->
                                            <thead>
                                                <!--begin::Table row-->
                                                <tr class="text-start text-muted fw-bolder fs-7 gs-0">
                                                    <th class="max-w-65px sorting_disabled">Id</th>
                                                    <th class="max-w-65px sorting_disabled">Имя</th>
                                                    <th class="max-w-85px sorting_disabled text-center">Разрешения</th>
                                                </tr>
                                                <!--end::Table row-->
                                            </thead>
