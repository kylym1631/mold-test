...
<!--begin::Head-->
<head>
    <title>{{__('Редактировать шаблон задач')}}</title>
                    ...
                    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                        ...
                        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                            ...
                            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                ...
                                <li class="breadcrumb-item text-dark">{{__('Редактировать шаблон задач')}}</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Title-->
                        </div>
                        ...
                        <div class="card js-data-table-wrap">
                            <div class="card-header mb-15">
                                <div class="card-title m-0">
                                    <h3 class="fw-bolder m-0">{{__('Редактировать шаблон задач')}}</h3>
                                </div>
