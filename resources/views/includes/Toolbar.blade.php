...
<div class="d-flex align-items-stretch flex-shrink-0">
    <!--begin::Search-->
    <div style="display:none !important;" class="d-flex align-items-stretch ms-1 ms-lg-3">
        <!--begin::Search-->
    ...
    <div class="d-flex align-items-center ms-1 ms-lg-3">
        <div id="login-timer" class="login-timer">
            <!--timer-->
        </div>
    </div>
    @endif
    ...
    <div class="d-flex align-items-center ms-1 ms-lg-3">
        <!--begin::Menu wrapper-->
        <div class="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px fw-normal" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            @if (App::isLocale('pl'))
                PL
            @else
                RU
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column w-150px" data-kt-menu="true">
            ...
            <div class="menu-item px-3">
                <a href="/set-locale/pl" class="menu-link d-flex px-5 @if (App::isLocale('pl')) active @endif">Polski</a>
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <a href="/set-locale/ru" class="menu-link d-flex px-5 @if (App::isLocale('ru')) active @endif">Русский</a>
            </div>
            <!--end::Menu item-->
        </div>
        <!--end::Menu-->
    ...
    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            @if(Auth::user()->Image_file != null)
                <img src="{{url('/')}}{{Auth::user()->Image_file->path}}" alt="user" />
            @else
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-325px" data-kt-menu="true">
            ...
            <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <!--end::Avatar-->
                    <!--begin::Username-->
                    <div class="d-flex flex-column align-items-start overflow-hidden" style="max-width: 100%; flex: 0 1 auto;">
                        <div class="fw-bolder d-flex align-items-center fs-5 text-uppercase">{{Auth::user()->firstName}} {{Auth::user()->lastName}}</div>
                        <a href="#" class="fw-bold text-muted text-hover-primary fs-7 overflow-hidden mb-1" style="max-width: 100%; white-space: nowrap; text-overflow: ellipsis">{{Auth::user()->email}}</a>
                        <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1">{{Auth::user()->getGroup()}}</span>
                    </div>
                    <!--end::Username-->
                </div>
            </div>
            ...
            <!--end::Menu item-->
            <!--begin::Menu separator-->
            <div style="display:none !important;" class="separator my-2"></div>
            <!--end::Menu separator-->
            <!--begin::Menu item-->
            <div style="display:none !important;" class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                @if (App::isLocale('pl'))
                <a href="#" class="menu-link px-5">
                    ...
                    <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">Polski
                    {{-- <img class="w-15px h-15px rounded-1 ms-2" src="{{url('/')}}/assets/media/flags/poland.svg" alt="" /> --}}
                </span></span>
                </a>
                @else
                <a href="#" class="menu-link px-5">
                    <span class="menu-title position-relative">Язык
                    <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">Русский
                    {{-- <img class="w-15px h-15px rounded-1 ms-2" src="{{url('/')}}/assets/media/flags/russia.svg" alt="" /> --}}
                </span></span>
                </a>
                @endif
                ...
                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="/set-locale/pl" class="menu-link d-flex px-5 @if (App::isLocale('pl')) active @endif">
                        <span class="symbol symbol-20px me-4">
                            {{-- <img class="rounded-1" src="{{url('/')}}/assets/media/flags/poland.svg" alt="" /> --}}
                        </span>Polski</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="/set-locale/ru" class="menu-link d-flex px-5 @if (App::isLocale('ru')) active @endif">
                        <span class="symbol symbol-20px me-4">
            ...
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div style="display:none !important;" class="menu-item px-5 my-1">
