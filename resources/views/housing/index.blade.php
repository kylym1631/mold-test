                            ...
                            <div class="card js-data-table-wrap">
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    ...
                                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                        ...
                                        @if (Auth::user()->hasPermission('housing.create'))
                                        <a href="/housing/add" class="btn btn-primary">Добавить</a>
                                        @endif
                                    </div>
                                    <!--end::Card toolbar-->
                                </div>
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="table-responsive">
                                        <table class="js-data-table table align-middle table-row-dashed fs-6 gy-3" data-route="{{route('housing.json')}}" data-tpl="Housing">
                                            <!--begin::Table head-->
                                            <thead>
                                                <!--begin::Table row-->
                                                <tr class="text-start text-muted fw-bolder fs-7 gs-0">
                                                    ...
                                                    <th class="max-w-85px sorting_disabled">Место работы</th>
                                                    <th class="max-w-45px sorting_disabled">Количество мест</th>
                                                    {{-- <th class="max-w-65px sorting_disabled">Стоимость аренды</th>
                                                    <th class="max-w-65px sorting_disabled">Стоимость за сутки</th> --}}
                                                </tr>
                                                <!--end::Table row-->
                                            </thead>
