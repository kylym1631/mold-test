                            ...
                            <div class="card js-data-table-wrap">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="table-responsive">
                                        <table class="js-data-table table align-middle table-row-dashed fs-6 gy-3" data-route="{{route('fields-mutation.json', ['id' => request()->get('id'), 'model_name' => 'Lead'])}}" data-tpl="LeadFieldMutation">
                                            <!--begin::Table head-->
                                            <thead>
                                                <!--begin::Table row-->
                                                <tr class="text-start text-muted fw-bolder fs-7 gs-0">
                                                    <th class="max-w-65px sorting_disabled">Дата</th>
